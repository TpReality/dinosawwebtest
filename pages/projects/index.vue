            ...
            <div class="banner-content">
                <div class="content-wrapper">
                                    ...
                                    <div class="dropdown-link">
                                        <div class="dropdown-container">
                                            <div class="dropdown-text-container">
                                                <span>{{ projectDetail.products_btn_text }}</span>
                                            </div>
                                        </div>
                        ...
                        <div class="badge-background">
                            <div class="badge-content">
                                ...
                                <div class="badge-text">
                                    <span class="badge-title">{{ projectDetail.last_update_date_text }}</span>
                                    <div class="badge-title">{{ projectDetail.last_update_date_value }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="title-section">
                        <h1 class="main-title">
                            {{ projectDetail.hero_main_title }}<br/>
                            <span class="title">{{ projectDetail.hero_main_subtitle }}</span>
                        </h1>
                    </div>
                    <div class="description-section">
                        <div class="description-text" v-html="projectDetail.hero_description"></div>
                    </div>
                </div>
            </div>
        </div>
...
const { data: projectsDetailRes, pending, error } = await useApi('/product-categories?filters[category_value][$eq]=projects&populate=all')
let processingCase = []

watch(projectsDetailRes, (newPosts) => {
    if (newPosts) {
        console.log(newPosts)
        let data = newPosts.data[0].project_main_page
