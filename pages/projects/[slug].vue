                            ...
                            <div class="breadcrumb-link">
                                <div class="breadcrumb-text">
                                    <div class="text-container">
                                        <span class="breadcrumb-home"><NuxtLink to="/">{{ projects.home_text }}</NuxtLink></span>
                                    </div>
                                </div>
                                <div class="breadcrumb-text">
                                    ...
                                    <div class="dropdown-link">
                                        <div class="dropdown-container">
                                            <div class="dropdown-text-container">
                                                <span class="breadcrumb-products"><NuxtLink to="/projects">{{ projects.products_btn_text }}</NuxtLink></span>
                                            </div>
                                        </div>
                                ...
                                <div class="breadcrumb-text">
                                 ...
                                 <div class="breadcrumb-text">
                                    <div class="text-container">
                                        <span>{{ projects.category_btn_text }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="badge-background">
                            <div class="badge-content">
                                ...
                                <div class="badge-text">
                                    <span class="badge-title">{{ projects.last_update_date_text }}</span>
                                    <div class="badge-title">{{ projects.last_update_date_value }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="processing-cases-title-section">
                <div class="processing-cases-title-frame">
                    <h2 class="processing-cases-title">
                        <span class="c-black" v-if="item.beforeTitle">{{ item.beforeTitle }}</span> {{ item.afterTitle }}
                        <div class="c-black">{{ item.subTitle }}</div>
                    </h2>
                </div>
            </div>
            <div class="processing-cases-description-section" v-if="item.text">
