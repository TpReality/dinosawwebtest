    ...
    <div class="main">
        ...
        <div class="main-content">
            ...
            <div class="view-content">
                ...
                <div class="rel">
                     <NuxtImg sizes="sm:100vw" loading="lazy" class="bg" src="https://honghaieim.obs.cn-east-3.myhuaweicloud.com/strapicms/images/4cNK7hR44yWDvsyolHiTPOzdfk.webp" />
                    <div class="stone-types">
                        <h2>{{ stones.what_kind_of_stone_is_this_title }}</h2>
                        <div class="stone-types-wrap">
                            <div class="stone-types-item">
                                <div class="rel float">
                                     <NuxtImg sizes="sm:100vw" loading="lazy" v-if="stones.what_kind_of_stone_is_this_left_top_image"
                            ...
                            <div class="stone-types-item">
                                <div class="rel float">
                                     <NuxtImg sizes="sm:100vw" loading="lazy" v-if="stones.what_kind_of_stone_is_this_right_top_image"
                        ...
                        <div class="stone-types-wrap">
                            <div class="stone-types-item">
                                <div class="rel float">
                                     <NuxtImg sizes="sm:100vw" loading="lazy" v-if="stones.what_kind_of_stone_is_this_left_bottom_image"
                            ...
                            <div class="stone-types-item">
                                <div class="rel float">
                                     <NuxtImg sizes="sm:100vw" loading="lazy" v-if="stones.what_kind_of_stone_is_this_right_bottom_image"
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <div class="nine-pic-wrap">
                                <div class="nine-pic">
                                     <NuxtImg sizes="sm:100vw" loading="lazy" alt="Interior decoration stone walls"
                                ...
                                <div class="nine-pic">
                                     <NuxtImg sizes="sm:100vw" loading="lazy" alt="Marble backdrop wall"
                                ...
                                <div class="nine-pic">
                                     <NuxtImg sizes="sm:100vw" loading="lazy" alt="Natural stone facades"
                                ...
                                <div class="nine-pic">
                                     <NuxtImg sizes="sm:100vw" loading="lazy" alt="Stone tombstones"
                                ...
                                <div class="nine-pic">
                                     <NuxtImg sizes="sm:100vw" loading="lazy" alt="Stone construction"
                                ...
                                <div class="nine-pic">
                                     <NuxtImg sizes="sm:100vw" loading="lazy" alt="Geology student"
        ...
        <div :class="['stone-list-fixed', { show: isShowResult }]">
                ...
                <div class="upload-image">
                     <NuxtImg sizes="sm:100vw" loading="lazy" :src="uploadImg" />
                </div>
                <div class="stone-list-wrap">
                    ...
                    <div v-else>
                        <div class="stone-list">
                            ...
                            >
                                 <NuxtImg sizes="sm:100vw" loading="lazy" :src="stone.img_url" />
                                <p>{{ stone.fileName }}</p>
                            </div>
                        </div>
        ...
        <div :class="['single-pic-fixed', { show: isShowSinglePic }]">
            ...
            <div class="image-box">
                <div class="image-name">{{ selectedImg?.fileName }}</div>
                 <NuxtImg sizes="sm:100vw" loading="lazy" class="image" :src="selectedImg?.img_url" />
                <a
