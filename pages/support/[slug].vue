            ...
            <div class="banner-content">
                <div class="content-wrapper">
                    ...
                    <div class="breadcrumb-container">
                        <div class="breadcrumb-wrapper">
                            ...
                            <div class="breadcrumb-dropdown">
                                ...
                                </div> <div class="breadcrumb-outer">
                                    <div class="bg">
                                        <p>
                            ...
                            <div class="breadcrumb-link">
                                ...
                                <div class="breadcrumb-text">
                                    <div class="text-container">
                                        <span class="breadcrumb-home">{{capitalizeFirstLetter(slug)}}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="title-section">
                        <h1 class="main-title">
                            The <span class="title">Industry Machinery User Manuals</span><br/>
                            You Can Use for Free
                        </h1>
                    </div>
                    <div class="description-section">
                        <p class="description-text">
                            Get free user manuals for CNC wire saw machines, bridge saws, engraving machines, drilling machines, waterjets, polishing machines, and diamond tools. These guides will help you understand how to maximize the performance of your equipment, troubleshoot common issues, and ensure smooth, efficient operation for your projects.
                        </p>
                    </div>
                </div>
            </div>
...
<script setup>
    ...
    const processingCase = [
        { id: 1, title: "Installation", subTitle: "Video Tutorials", text: "Diamond Tools" }
    ]
</script>
