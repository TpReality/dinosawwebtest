                            ...
                            <div class="expert-guide-image-section">
                                <div class="expert-guide-image-container">
                                    <div class="expert-guide-image">
                                        <NuxtImg src="https://honghaieim.obs.cn-east-3.myhuaweicloud.com/strapicms/images/7p45OXHfHH4pRmHd3kl2v7DaA.webp" />
                                    </div>
                                </div>
                            </div>
                        </div>
...
.main {
    ...
    .blog-section{
        ...
        .wire-saw-machine-section:nth-child(odd){
            padding:30px 0;
            background:url(https://honghaieim.obs.cn-east-3.myhuaweicloud.com/strapicms/images/4cNK7hR44yWDvsyolHiTPOzdfk.webp) no-repeat center center;
