            ...
            <div class="banner-content">
                <div class="content-wrapper">
                    ...
                    <div class="title-section">
                        <h1 class="main-title">
                            Find <span class="title">The best CNC Machine</span><br/>
                            Video Tutorials
                        </h1>
                    </div>
                    <div class="description-section">
                        <p class="description-text">
                            Video tutorials include professional installation, maintenance, and repair guidance for CNC wire saw machines, bridge saws, waterjets, engraving machines, and more! 
                            We hope these resources are helpful to you in optimizing your equipment's performance. 😎👍
                        </p>
                    </div>
                </div>
            </div>
